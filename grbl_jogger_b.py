...
class MainWindow(wx.Frame):
	...
	self.dirname = '.'    
        ...
        jogPanel = wx.Panel(self, -1, style=wx.SUNKEN_BORDER)        
     
        #editorPanel = wx.Panel(self, -1, style = wx.SUNKEN_BORDER)
	...
	#	Buttons;  One per direction
        XPlusButton = wx.Button(jogPanel, -1, 'X+',size=(75,75))
        XMinusButton = wx.Button(jogPanel, -1, 'X-',size=(75,75))
        YPlusButton = wx.Button(jogPanel, -1, 'Y+',size=(75,75))
        YMinusButton = wx.Button(jogPanel, -1, 'Y-',size=(75,75))
        ZPlusButton = wx.Button(jogPanel, -1, 'Z+',size=(75,75))
        ZMinusButton = wx.Button(jogPanel, -1, 'Z-',size=(75,75))
        
        #setHomeButton = wx.Button(editorPanel, -1, 'Set Home')       
        #self.codeViewer = wx.TextCtrl(self, -1, '', style=wx.TE_MULTILINE|wx.VSCROLL)
        #startButton = wx.Button(editorPanel, -1, 'Start')
        #stopButton = wx.Button(editorPanel, -1, 'Stop')
        
        
        #	Input boxes for distance and speed
        self.distanceLabel = wx.StaticText(jogPanel, 1, "Distance:")
        self.distanceBox = wx.TextCtrl(self)
        self.speedLabel = wx.StaticText(jogPanel, 1, "IPM:")
        ...
        #self.editorSizer1.Add(setHomeButton, 1, wx.EXPAND)
        #self.editorSizer2.Add(self.codeViewer, 1, wx.EXPAND)      
        #self.editorSizer3.Add(startButton, 1, wx.EXPAND)
        #self.editorSizer3.Add(stopButton, 1, wx.EXPAND)
       ...
       # self.rootSizer.Add(self.editorSizer2, 10, wx.EXPAND)
